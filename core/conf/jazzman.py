JAZZMIN_SETTINGS = {
    ...
    "site_title": "Hidoya ARM",

    # Title on the login screen (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_header": "Hidoya ARM",

    # Title on the brand (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_brand": "Hidoya ARM",
    ...
    "icons": {
        ...
        "books.Alphabet": "fas fa-font",
        "books.Language": "fas fa-globe",
        "books.Category": "fas fa-list",
        "e_books.E_Category": "fas fa-list",
        "e_books.E_Book": "fas fa-atlas",
        "users.Course": "fas fa-bookmark",
        "users.UserProfile": "fas fa-user",
        "users.Group": "fas fa-users",
        "orders.Order": "fas fa-handshake",
    },
    ...
    "custom_css": "custom-panel/css/main.css",
    "custom_js": None,
